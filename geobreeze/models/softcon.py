...
class SoftCon(EvalModelWrapper):
    ...
    def _load_encoder(self, 
        ...
        # load dino model
        encoder = torch.hub.load("facebookresearch/dinov2", dinov2_torchhub_id)
        ...
        encoder.patch_embed.proj = torch.nn.Conv2d(
            num_channels, embed_dim, kernel_size=(14, 14), stride=(14, 14)
        )

        state_dict = torch.hub.load_state_dict_from_url(
            self.URL.format(hf_filename), map_location="cpu")
